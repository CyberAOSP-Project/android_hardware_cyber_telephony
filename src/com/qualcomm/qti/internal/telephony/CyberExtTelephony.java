...
public class CyberExtTelephony extends IExtTelephony.Stub {
    ...
    private static CyberExtTelephony sInstance;
    ...
    public static CyberExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new CyberExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private CyberExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
